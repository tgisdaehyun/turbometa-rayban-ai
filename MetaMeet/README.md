...
HTTPS/Tailscale 자동 원음 백업, 수신 확인, 마이크 자동 재연결, 호스트 사후 전사를 추가했습니다. 신규 설치의 기본 전사 간격은 15초입니다. 기존 속도 선택은 유지하며 개인용 호스트 설정을 처음 적용할 때만 15초로 바꿉니다. 설치·번역 키 설정·실기 검증은 [호스트 안내](Host/README.md)를 참고하세요. 아래 1.1 기록의 2초 기본값과 “자체 서버 없음” 설명은 이전 버전 기준입니다.
